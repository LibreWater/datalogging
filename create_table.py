...
cursor.execute("INSERT INTO myapp_run (description, start_time, end_time) VALUES (%s, %s, %s)", ("Test run", start_time, start_time))
cursor.execute("SELECT id FROM myapp_run ORDER BY id DESC LIMIT 1")
